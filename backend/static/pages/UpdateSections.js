...
const UpdateSection={
    ...
    <div class="d-flex justify-content-center align-items-center vh-100">
      <div class="card shadow p-4">
        <h3 class="card-title text-center mb-4">Update Section</h3>
    ...
    async mounted(){
        ...
        const res=await fetch(window.location.origin+'/sectiondet/'+section_id,{
            headers:{
    ...
    methods:{
        async AddSec(){
            const section_id= this.$route.params.id
            const url= window.location.origin+'/api/sections/'+section_id;
